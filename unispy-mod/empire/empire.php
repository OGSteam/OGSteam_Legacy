...
function clear_box_mod_empire() {
	if (document.form.ship.value == "Je copie ici la partie \"Flottes\" d'Univers.") {
...
<table width="90%">
	...
	<tr>
	<th colspan='13'>
		<textarea name='ship' onFocus='clear_box_mod_empire()'>Je copie ici la partie "Flottes" d'Univers.</textarea><br>
...
$user_data["user_id"] = $empire_user_id;
	...
	switch ($pub_subaction) {
		...
		case "simulation" :
		require_once("views/home_simulation.php");
		break;

		case "stat" :
		require_once("views/home_stat.php");
		break;

...
for (i=1;i<=9;i++) document.getElementById('global' + i).checked = sel;
verif_donnee ();
}
...
geologue = 1;
if (document.getElementById('geologue').checked) geologue = 1.1;
...
for ($i=1;$i<=9;$i++) echo ", ".($user_building[$i]["fields_used"] - $user_building[$i]['M'] - $user_building[$i]['C'] - $user_building[$i]['D'] - $user_building[$i]['CES'] - $user_building[$i]['CEF']);
?>);
energie = new Array();
...
for ($i=1;$i<=9;$i++) echo "\t<th><font color='lime'><span id='cases".$i."'></span></font> / <font color='lime'><span id='cases_tot".$i."'></span></font></th>\n";
?>
</tr>
<tr>
	<th><a>
...
for ($i=1;$i<=9;$i++) echo "\t<th><font color='lime'><span id='energie".$i."'></span></font> / <font color='lime'><span id='energie_tot".$i."'></span></font></th>\n";
?>
</tr>
<tr>
...
for ($i=1;$i<=9;$i++) echo "\t<th><span id='fact".$i."'></span></th>\n";
?>
</tr>
<?php
for ($b=1;$b<=3;$b++) {
	echo "<tr><th><a>".$lang['prod_building_'.$bati[$b]]."</a></th>";
	for ($i=1;$i<=9;$i++) echo "\t<th><span id='prodh_".$bati[$b].$i."'></span></th>\n";
	echo "</tr>";
}
?>
<tr>
...
for ($b=1;$b<=3;$b++) {
	echo'<tr><th><a>'.$lang['prod_building_'.$bati[$b]].'</a></th>';
	for ($i=1;$i<=9;$i++) echo "\t<th><span id='prodj_".$bati[$b].$i."'></span></th>\n";
	echo "</tr>";
}
?>
<tr>

...
if ($search && $error == 0 && isset($rapports)) {
	foreach ($points_technology as $key => $value) {
		...
		$points["recherches"] += floor($points_technology[$key] * (pow($puissance_technology[$key], $technologies[$key]) - 1));
	}
}

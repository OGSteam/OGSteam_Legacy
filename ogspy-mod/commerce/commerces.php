<?php
/**
* commerce.php Fichier principal
* @package commerce
* @author Mirtador
...
<table width='100%'>
	...
	<tr>
		<th colspan="4">
			<form action='index.php?action=commerce&page=commerce' method='post' name='date'>

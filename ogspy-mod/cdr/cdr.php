...
<br/><br/>
<table width='30%'><tr align='center'>
<td class='c'><span onclick="document.location.href='index.php?action=cdr&galaxy=all'"><b>ALL</b></td>
<?php
for ($i=1;$i<=$server_config['num_of_galaxies'];$i++) echo "<td class='c'><span onclick=\"document.location.href='index.php?action=cdr&galaxy=".$i."'\"><b>G".$i."</b></span></td>";
?>
</tr></table>
<br/>
<table width='80%' id="trier">
	<tr class=title>
		<td class='c' align='center'><span onclick=TableOrder(event,0)>&#9660;&nbsp;</span><?php echo $lang['coord']; ?><span onclick=TableOrder(event,1)>&nbsp;&#9650;</span></td>
		<td class='c' align='center'><span onclick=TableOrder(event,0)>&#9660;&nbsp;</span><?php echo $lang['nb_recy']; ?><span onclick=TableOrder(event,1)>&nbsp;&#9650;</span></td>
		<td class='c' align='center'><span onclick=TableOrder(event,0)>&#9660;&nbsp;</span><?php echo $lang['total']; ?><span onclick=TableOrder(event,1)>&nbsp;&#9650;</span></td>
		<td class='c' align='center'><span onclick=TableOrder(event,0)>&#9660;&nbsp;</span><?php echo $lang['metal']; ?><span onclick=TableOrder(event,1)>&nbsp;&#9650;</span></td>
		<td class='c' align='center'><span onclick=TableOrder(event,0)>&#9660;&nbsp;</span><?php echo $lang['crystal']; ?><span onclick=TableOrder(event,1)>&nbsp;&#9650;</span></td>
		<td class='c' align='center'><span onclick=TableOrder(event,0)>&#9660;&nbsp;</span><?php echo $lang['date']; ?><span onclick=TableOrder(event,1)>&nbsp;&#9650;</span></td>
	</tr>
...
<form action="index.php?action=cdr&subaction=option" name="form1" method="POST">
	...
	<table width='20%'>
		...
		<tr>
			<th class='c' width='20%'><?php echo $lang['more_than']; ?> <input style="text-align:center" type="text" size="10" name="t_med" value="<?php echo $tc['medium']; ?>" /></th>
		...
		<tr>
			<th class='c' width='20%'><?php echo $lang['more_than']; ?> <input style="text-align:center" type="text" size="10" name="t_big" value="<?php echo $tc['big']; ?>" /></th>

...
echo"<li>Correction petit probl&egrave;me dans le module de liaison Xtense2 - Merci Sylar </li>";
echo"<li>Remplacement de la fonction 'menu'</li>";
echo"<li>Correction de l'affichage des RC</li>";
echo"<li>Ajout des coordonn&eacute;es de l'attaquant et du d&eacute;fenseur dans la base de donn&eacute;es</li>";
echo"<li>Ajout du nombre de rapports supprim&eacute;s et du nombre de points des rapports supprim&eacute;s dans la base de donn&eacute;es</li>";
echo"<li>Ajout d'un timestamp dans les rapports de recyclage</li>";
echo"<li>Page Affichage: Cr&eacute;ation de la liste des joueurs avec des 'checkbox' pour sélectionner</li>";
echo"<li>Page Affichage: Possibilit&eacute; d'afficher tout les joueurs dans 1 seul tableau</li>";
...
echo"<li>Administration: Possibilit&eacute; de changer le nombre de ligne dans les tableaux de la page 'Affichage'</li>";
echo"<li>Administration: Soft Purge - Supprime les rapports avec un nombre de points inf&eacute;rieurs &agrave; une valeur d&eacute;finie</li>";
...
echo"<li>Administration: Nettoyage - Suppression des RC orphelins dont le joueur n'est plus actif et des RC d&eacute;fenseur.</li>";
echo"<li>Administration: Ajout de bulles d'aides sur les nouvelles fonctions</li>";
echo"<li>Xtense2: N'accepte plus les rapports d&eacute;fenseurs</li>";
echo"<li>Xtense2: insertion automatique des rapports de recyclages (enfin j'espère)</li>";
echo"<li>Correction page Nouveau RC, même r&egrave;gles que Xtense2</li>";
...
echo"<li>Page Admin: D&eacute;tection de Xtense2 et connection</li>";
echo"</ul></font></p>";
echo"</fieldset>";
echo"<br>";
echo"<br>";

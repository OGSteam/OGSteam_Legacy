...
$query = "INSERT INTO ".TABLE_MOD." ( title, menu, action, root, link, version, active) VALUES ('Building techno hof','Build.Tech HOF','bt_hof','bt_hof','bt_hof.php','".trim($file[1])."','1')";
$db->sql_query($query);

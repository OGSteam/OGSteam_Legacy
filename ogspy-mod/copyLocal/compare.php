...
*   package     : Copy_local
*	desc.		: compare le contenu (taille et nb de lignes) des tables distantes et locales pour visualiser les table à mettre à jour
...
$link_local = connectSQL($local['host'] ,$local['user']  , $local['password'] , $local['database'] );
...
echo "<tr><td class='c'>&nbsp;</td><td class='c'>Table</td><td class='c'>Taille distante</td><td class='c'>Taille locale</td><td class='c'>Nb de ligne distante</td><td class='c'>Nb de ligne locale</td></tr>";
...
while ($row = mysql_fetch_assoc($result))
{
    foreach($row as $key=>$value)
    {
        ...
        $local_table = str_replace($distant['prefix'],$local['prefix'],$value);

...
define("EW_CONN_USER", 'test', TRUE);
define("EW_CONN_PASS", 'test', TRUE);
define("EW_CONN_DB", 'ogspy_update', TRUE);
...
// Security
define("EW_ADMIN_USER_NAME", "test", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "test", TRUE); // Administrator password

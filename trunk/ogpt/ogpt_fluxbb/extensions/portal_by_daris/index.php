...
if ($forum_db->num_rows($result))
{
	while ($cur_news = $forum_db->fetch_assoc($result))
	{
		...
		$forum_page['info'][] = '<a href="'.forum_link($forum_url['topic'], array($cur_news['id'], sef_friendly($cur_news['subject']))).'">'.$lang_portal['Comments'].': '.$cur_news['num_replies'].'</a>';

		// if option for displaying avatar in news is enabled
		if ($forum_config['o_portal_news_avatar'] == '1')
			$forum_page['avatar_markup'] = generate_avatar_markup($cur_news['poster_id']);
...
<?php if (isset($forum_page['avatar_markup']) && $forum_page['avatar_markup'] != '') : ?>			<div class="avatar-left"><?php echo $forum_page['avatar_markup'] ?></div><?php endif; ?>
...
<div id="pun-main" class="main">
	...
	<div class="main-content portal news">
		<div class="entry-content">

...
?>
		...
		<tr>
			<th>&nbsp;</th>
			<th>Galaxie</th>
			<th><input name="galaxy_down" type="text" maxlength="1" size="3" value="<?php echo $galaxy_down;?>"></th>
			<th><input name="galaxy_up" type="text" maxlength="1" size="3" value="<?php echo $galaxy_up;?>"></th>
		</tr>
		<tr>
			<th>&nbsp;</th>

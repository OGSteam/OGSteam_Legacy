...
*	desc.		:
*	Author		: Ben.12 - http://ogs.servebbs.net/
*	created		: 22/01/2006
...
$title = "Basé sur vos données dans \"Empire\" et les stats de ".$user_data["user_stat_name"]." du ".strftime("%d %b %Y %H:%M", $last_date["general"]);
...
<br />
		...
		<table>
		<tr>
			<td class="c" colspan="7">Classement de <a><?php echo $user_data["user_stat_name"];?></a></td>
		</tr>
		<tr>

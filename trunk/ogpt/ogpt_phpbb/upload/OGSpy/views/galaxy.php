...
$galaxy_up = (($galaxy-1) > 9) ? 9 : $galaxy + 1;

$system_down = (($system-1) < 1) ? 1 : $system - 1;
$system_up = (($system-1) > 499) ? 499 : $system + 1;
	...
	<td>
		<table align="center">
			...
			<tr>
				...
				<td class="l"><input type="text" name="galaxy" maxlength="1" size="5" value="<?php echo $galaxy;?>" tabindex="1"></td>
...
<tr>
	<td class="c" colspan="8">Système solaire </td>
</tr>
<tr>
...
$legend .= "<tr><td class=\"c\">Lune<br><i>phalange 4 avec porte spatiale</i></td><th>M - 4P</th></tr>";
$legend .= "<tr><td class=\"c\">Rapport d\'espionnage</td><th>xE</th></tr>";
$legend .= "<tr><td class=\"c\">Joueur / Alliance alliée</td><th><blink><a>abc</a></blink></th></tr>";
...
else echo "<tr><th>Aucune phalange répertoriée a une portée suffisante pour phalanger les planètes de ce systeme</th></tr>";
echo "</table>";

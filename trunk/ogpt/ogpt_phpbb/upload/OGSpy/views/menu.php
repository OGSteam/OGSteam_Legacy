...
<tr>
	<td><img src="<?php echo $link_css;?>/gfx/ogame-produktion.jpg" width="110" height="40" /></td>
</tr>
<?php
...
<tr>
	<td><div align="center"><font color="#FFFFFF"><a href="index.php?action=home">Espace personnel</a></font></div></td>
</tr>
<tr>
	<td><div align="center"><a href="index.php?action=about">A propos ...</a></div></td>
</tr>
<tr>
	<td><img src="<?php echo $link_css;?>/gfx/user-menu.jpg" width="110" height="19"></td>
</tr>
<tr>
	<td><div align="center"><a href="index.php?action=galaxy">Galaxie</a></div></td>
</tr>
<tr>
	<td><div align="center"><a href="index.php?action=cartography">Espace alliance</a></div></td>
</tr>
<tr>
	<td><div align="center"><a href="index.php?action=search">Recherche</a></div></td>
</tr>
<tr>
	<td><div align="center"><a href="index.php?action=ranking">Classement</a></div></td>
</tr>
<tr>
	<td><img src="<?php echo $link_css;?>/gfx/user-menu.jpg" width="110" height="19"></td>
</tr>
<tr>
	<td><div align="center"><a href="index.php?action=statistic">Statistiques</a></div></td>
</tr>
<tr>
	<td><div align="center"><a href="index.php?action=galaxy_obsolete">Syst. obsolètes</a></div></td>
</tr>
<!-- Emplacement mod /-->
<?php
$request = "select action, menu from ".TABLE_MOD." where active = 1 order by position, title";
...
else echo "Vous ne disposez pas des droits necessaire pour importer des informations sur le serveur";
echo "</textarea></td>"."\n";
echo "</tr>"."\n";

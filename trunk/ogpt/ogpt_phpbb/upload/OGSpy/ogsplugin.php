 ...
 **/
  global $pub_gametype;
	if(isset($pub_typ))
		switch($pub_typ){
			case 'stats':		OGSPlugin_Traitement_Stats();			break;
			
			case 'galaxy':		OGSPlugin_Traitement_Galaxie();			break;
			
			case 'galaxyraw':	if ($pub_gametype == 'ogame') OGSPlugin_Traitement_Galaxyraw();
      break;
      
			case 'reports':		OGSPlugin_Traitement_Messages();
      break;
      
			case 'combreports':	if ($pub_gametype == 'ogame') OGSPlugin_Traitement_RCombat();
                          else SendHttpStatusCode("799");
      break;
      
			case 'allyhistory':	if ($pub_gametype == 'ogame') OGSPlugin_Traitement_Allyhistory();
                          else SendHttpStatusCode("799");
      break;
      
			case 'buildings':	if ($pub_gametype == 'ogame') OGSPlugin_Traitement_Batiments();
                        else SendHttpStatusCode("799");
      break;
      
			case 'resources':		if ($pub_gametype == 'ogame') OGSPlugin_Traitement_Ressources();
                          else SendHttpStatusCode("799");
      break;
      
			case 'technos':		if ($pub_gametype == 'ogame') OGSPlugin_Traitement_Laboratoire();
                        else SendHttpStatusCode("799");
      break;
      
			case 'shipyard':	if ($pub_gametype == 'ogame') OGSPlugin_Traitement_ChantierSpatial();
                        else SendHttpStatusCode("799");
      break;
      
			case 'flotten':		if ($pub_gametype == 'ogame') OGSPlugin_Traitement_Flotte();
                        else SendHttpStatusCode("799");
      break;
      
			case 'defence':		if ($pub_gametype == 'ogame') OGSPlugin_Traitement_Defense();
                        else SendHttpStatusCode("799");
      break;
      
			case 'planetempire': if ($pub_gametype == 'ogame' || $pub_gametype == 'eunivers') OGSPlugin_Traitement_EmpirePlanetes();
                           else SendHttpStatusCode("799");
      break;
      
			case 'moonempire':	if ($pub_gametype == 'ogame') OGSPlugin_Traitement_EmpireLunes();
                          else SendHttpStatusCode("799");
      break;
      
			case 'planetdetails':	if ($pub_gametype == 'ogame') OGSPlugin_Traitement_DetailsPlanete();
                            else SendHttpStatusCode("799");
      break;
      
			default:	SendHttpStatusCode("799"); /*		SendHttpStatusCode(799); */	break;
		} else

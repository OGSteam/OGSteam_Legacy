...
*
* @package ucp
* @version $Id: ucp_profile.php,v 1.123 2007/07/21 03:53:09 davidmj Exp $
		...
		switch ($mode)
		{
			...
			case 'profile_info':
				...
				$data = array(
					...
					'meteo_name' 	=> request_var('meteo_name', $user->data['meteo_name']),
				...
				if ($submit)
				{
					$validate_array = array(
						...
						'meteo_name' 	=> array('string', true, 5, 120),
						'website'		=> array(

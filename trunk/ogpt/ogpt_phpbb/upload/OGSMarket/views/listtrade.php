...
<tr>
	<td>
		<table width="100%">
		<tr>
			<th colspan=12>Marché de l'<?php echo $current_uni["name"]; ?></th>
		</tr>
		<tr>
		...
		<tr>
			<td class="k"><a href="index.php?action=listtrade&amp;sortby=offermetal">Métal</a></th>
			<td class="k"><a href="index.php?action=listtrade&amp;sortby=offercrystal">Cristal</a></th>
			<td class="k"><a href="index.php?action=listtrade&amp;sortby=offerdeut">Deutérium</a></th>
			...
			<td class="k"><a href="index.php?action=listtrade&amp;sortby=wantdeut">Deutérium</a></th>

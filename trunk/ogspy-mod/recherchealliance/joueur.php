...
if ( isset( $pub_ally ) && ( $pub_ally <> '' ) )
{
	...
	$bbcode = "[code]Classement Des joueurs[/code]\n";
	...
	$bbcode .= "\n[quote][color=cyan][b]Joueur[/b] [/color][color=yellow][b]points (Place)[/b][/color][color=red] [b]vaisseaux (Place)[/b][/color][color=white] [b]recherches (Place)[/b][/color]\n";
      
      //Les bbcodes pour Forum sans quote et code
      $bbcode8 = "[b]Classement Des joueurs[/b]\n";
	...
	$bbcode8 .= "\n[color=cyan][b]Joueur[/b] [/color][color=yellow][b]points (Place)[/b][/color][color=red] [b]vaisseaux (Place)[/b][/color][color=white] [b]recherches (Place)[/b][/color]\n";

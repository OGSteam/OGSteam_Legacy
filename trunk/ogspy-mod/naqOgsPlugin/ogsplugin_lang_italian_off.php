<?php
/***************************************************************************
*	filename	: ogsplugin_lang_italian.php
*	desc.		: Fichier de langue IT pour ogsplugin.php
*	Author		: Naqdazar   - 
*	created		: 28/11/2006
*	modified	: 
***************************************************************************/
...
$ogp_lang["forumlinkinfo_tail"]="Si Forum OGS Team indisponible";
...
$ogp_lang["pluglogopts_main"]="Option de journalisation du plugin";
$ogp_lang["pagehandling_main"]="Traitement des Pages - Données Communes";
$ogp_lang["miscellanous_main"]="Divers(Sécurité)";
$ogp_lang["diplomaty_main"]="Diplomatie";
$ogp_lang["redirection_main"]="Message de Redirection";
$ogp_lang["usersinfos_main"]="Infos de configuration Utilisateur";

// texte bulles d'aide
$ogp_lang["ogsplug_univ_help"] = "Nom du serveur de l'univers associé au serveur OGSPY courant.<br><i>Ex pour l'univers 12: ogame190.de</i>";
$ogp_lang["ogsplug_loghelp_help"] = "Libellés des opérations qui seront enregistrées dans le journal.<br>02/11/2006 00:49:25 :  naqdazar charge 15 planètes du système 2:294(2:294) via plugin OGSPY (1.0.975)";
$ogp_lang["ogsportailurl_help"] = "Valider cette option avant que la liste des univers ne puisse changer!";
$ogp_lang["ogsactivate_debuglog_help"] = "Cette option peut réveler des informations confidentielles<br>et  n'est déstinée qu'à des fins de déboguage.<br>L'utiliser relève de votre responsabilité!";
...
// Interface module
$ogp_lang["moduleinterf_lang"] = "Interface Module";
...
$ogp_lang["blockextrarequests_misc"] = "Bloquer les requètes provenant d'un serveur ogame non désigné";

...
{
	$graphicTot = <<<GRAPH
	<img src="index.php?action=graphic_pie&values=$res[nombreExpRess]_x_$res[nombreExpVaiss]_x_$res[nombreExpMarch]_x_$res[nombreExpRate]_x_$res[nombreExpCombat]&legend=Ressources_x_Vaisseaux_x_Marchands_x_Ratees_x_Combat&title=Proportion%20des%20differents%20types" alt="Pas de graphique disponible">
GRAPH;
}
else
	{
...
if($res4month['nombreExpTot'] != 0)
{
	...
	<img src="index.php?action=graphic_pie&values=$res4month[nombreExpRess]_x_$res4month[nombreExpVaiss]_x_$res4month[nombreExpMarch]_x_$res4month[nombreExpRate]_x_$res4month[nombreExpCombat]&legend=Ressources_x_Vaisseaux_x_Marchands_x_Ratees_x_Combat&title=Proportion%20des%20differents%20types%20pour%20le%20mois" alt="Pas de graphique disponible">
GRAPH;
}
else
	{
...
if($res['nombreExpRess'] != 0)
	{
		$graphicRess = <<<GRAPH
		<img src="index.php?action=graphic_pie&values=$res[sumMetal]_x_$res[sumCristal]_x_$res[sumDeuterium]_x_$res[sumAntiMat]_x_$res[sumPerte]&legend=Metal_x_Cristal_x_Deuterium_x_Antimatiere_x_Perte%20Combat&title=Proportion%20des%20ressources" alt="Pas de graphique disponible"> 
GRAPH;
	}
else
	{
...
if($res4month['nombreExpRess'] != 0)
	{
		...
		<img src="index.php?action=graphic_pie&values=$res4month[sumMetal]_x_$res4month[sumCristal]_x_$res4month[sumDeuterium]_x_$res4month[sumAntiMat]_x_$res4month[sumPerte]&legend=Metal_x_Cristal_x_Deuterium_x_Antimatiere_x_Perte%20Combat&title=Proportion%20des%20ressources%20pour%20le%20mois" alt="Pas de graphique disponible">
GRAPH;
	}
else
	{
...
<table style="text-align: left; height: 150px;" border="0" cellpadding="2" cellspacing="2">
	<tbody>
		...
		<tr>
			<td class="c" style="width: 500px;"><big>Nombre d'eXpeditions avec combat :</big></td>
			<td class="c" style="width: 100px;"><big>$res[nombreExpCombat] ($res[pourcentExpCombat]%)</big></td>
			<td class="c" style="width: 100px;"><big>$res4month[nombreExpCombat] ($res4month[pourcentExpCombat]%)</big></td>
		</tr>
	</tbody>
</table>
<br />
...
<table style="text-align: left; " border="0" cellpadding="2" cellspacing="2">
	<tbody>
		...
		<tr>
			<th style="width: 225px;">Perte Combat</th>
			<th style="width: 125px;">$res[sumPerte]</th>
			<td style="width: 50px;"></td>
			<th style="width: 225px;">Perte Combat</th>
			<th style="width: 125px;">$res4month[sumPerte]</th>
		</tr>
		<tr>

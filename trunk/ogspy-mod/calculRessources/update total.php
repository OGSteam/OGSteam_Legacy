...
{
  print '<h2 style="font-color; font-color">Erreur lors de la mise à jour du mod ! Veuillez réessayer ou consulter le forum http://ogsteam.fr pour résoudre le problème !</h2>';
}
?>
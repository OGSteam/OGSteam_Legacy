// constants
const APP_DISPLAY_NAME = "OGSPY toolbar for Ogame";
const APP_NAME = "ogsplugin";
const APP_PACKAGE = "/ogsplugin";
const APP_VERSION = "2.2.8";
const WARNING = "WARNING: You need administrator priviledges to install OGSSPy toolbar. It will be installed in the application directory for all users. Installing Galaxy Toolbar in your profile is only supported for Firefox 0.9+. Proceed with the installation?";
const locales = ["fr-FR", /* "pl-PL", */ "en-US" /*, "de-DE", "es-ES" */ ];
...
if (confirm(WARNING)) {
  ...
  // file-check array
  var dirArray = [
    [getFolder("Profile", "chrome"), "ogsplugin.jar"],      // Profile jar
    [getFolder("Chrome"), "ogsplugin.jar"],                 // Root jar
  ...
  var files = [
    ["chrome/ogsplugin.jar", getFolder("Chrome")],
   // ["defaults/preferences/ascriptfile.js", getFolder(getFolder("Program", "defaults"), "pref")],
	null
  ];
  ...
  var jar = getFolder(getFolder("Chrome"), "ogsplugin.jar");
  try {
    ...
    alert("OGSSpy Toolbar " + APP_VERSION + " is now installed.\n" +

...
document.all.ColorPreview<?php echo $i; ?>.style.backgroundColor = colors;
<?php } ?>
...
function Set(ally) {
			...
			<?php for ($i = 1 ; $i <= $nb_colonnes_ally ; $i ++){  ?>
		case <?php echo $i; ?>:
			document.all.color_ally[<?php echo $i; ?>].value = colors;
			break;
<?php } ?>
	}
}
...
<tr>
	<td class="c" colspan="2">Option de la page: "Statistique"</td>
</tr>
<tr>
...
<tr>
	<td class="c" colspan="2">Option de la page: "Espace alliance"</td>
</tr>
<tr>
...
<tr>
	...
	<th><input name="color_ally[<?php echo $i; ?>]" type="text" size="15" maxlength="20" value="<?php echo $color_ally_e[$i-1];?>"> <?php echo help("color_picker".$i);?></th>
</tr>
<?php } ?>
<tr>
	<th>Nombre de galaxies par ligne <a>[1-100]</a></th>
...
<tr>
	<td class="c" colspan="2">Option de la page: "Login"</td>
</tr>
<tr>
	<th width="60%">Affichage du panneau inscription&nbsp;<?php echo help(null,"Affiche ou cache le tableau contenan le lien du forum de cet SpacSpy");?></th>
...
<tr>
	<th width="60%">Nom de l'alliance&nbsp;<?php echo help(null,"Nom de l'alliance de cet SpacSpy");?></th>
	<th><input type="text" size="60" name="register_alliance" value="<?php echo $register_alliance;?>"></th>
</tr>
<tr>
	<th width="60%">Lien du forum d'inscription&nbsp;<?php echo help(null,"Lien d'une section du forum, voir le PM de l'administrateur SpacSpy");?></th>

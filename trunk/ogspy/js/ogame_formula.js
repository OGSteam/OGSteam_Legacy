...
function update_page() {
	...
	if (Geo < 1){
	var M_1_prod = Math.round(production("M", M_1, Temp_1, NRJ) * M_1_percentage / 100);
	} else {
	var M_1_prod = Math.round((production("M", M_1, Temp_1, NRJ) * M_1_percentage / 100) + (production("M", M_1, Temp_1, NRJ) * M_1_percentage / 100)/10);
	}
	...
	if (Geo < 1){
	var C_1_prod = Math.round(production("C", C_1, Temp_1, NRJ) * C_1_percentage / 100);
	} else {
	var C_1_prod = Math.round((production("C", C_1, Temp_1, NRJ) * C_1_percentage / 100) + (production("C", C_1, Temp_1, NRJ) * C_1_percentage / 100)/10);
	}
	...
	var CES_1_production = production("CES", CES_1, Temp_1, NRJ) * CES_1_percentage / 100;

	//CEF - Planète 1
	var CEF_1 = document.getElementById("CEF_1").value;
	var CEF_1_percentage = document.getElementById("CEF_1_percentage").value;
	var CEF_1_production = production("CEF", CEF_1, Temp_1, NRJ) * CEF_1_percentage / 100;

	//Sat - Planète 1
	var Sat_1 = document.getElementById("Sat_1").value;
	var Sat_1_percentage = document.getElementById("Sat_1_percentage").value;
	var Sat_1_production = production_sat(Temp_1) * Sat_1 * Sat_1_percentage / 100;
	...
	if (Geo < 1){
	var D_1_prod = Math.round(production("D", D_1, Temp_1, NRJ) * D_1_percentage / 100) - Math.round(consumption("CEF", CEF_1) * CEF_1_percentage / 100);
	} else {
	var D_1_prod = (Math.round(production("D", D_1, Temp_1, NRJ) * D_1_percentage / 100) - Math.round(consumption("CEF", CEF_1) * CEF_1_percentage / 100)) + (Math.round(production("D", D_1, Temp_1, NRJ) * D_1_percentage / 100) - Math.round(consumption("CEF", CEF_1) * CEF_1_percentage / 100))/10;
	}
	...
	var NRJ_1 = Math.round(CES_1_production + CEF_1_production + Sat_1_production + (CES_1_production + CEF_1_production + Sat_1_production)/10);
	}
	...
	if (Geo < 1){
	var M_2_prod = Math.round(production("M", M_2, Temp_2, NRJ) * M_2_percentage / 100);
	} else {
	var M_2_prod = Math.round((production("M", M_2, Temp_2, NRJ) * M_2_percentage / 100) + (production("M", M_2, Temp_2, NRJ) * M_2_percentage / 100)/10);
	}
	...
	if (Geo < 1){
	var C_2_prod = Math.round(production("C", C_2, Temp_2, NRJ) * C_2_percentage / 100);
	} else {
	var C_2_prod = Math.round((production("C", C_2, Temp_2, NRJ) * C_2_percentage / 100) + (production("C", C_2, Temp_2, NRJ) * C_2_percentage / 100)/10);
	}
	...
	var CES_2_production = production("CES", CES_2, Temp_2, NRJ) * CES_2_percentage / 100;

	//CEF - Planète 2
	var CEF_2 = document.getElementById("CEF_2").value;
	var CEF_2_percentage = document.getElementById("CEF_2_percentage").value;
	var CEF_2_production = production("CEF", CEF_2, Temp_2, NRJ) * CEF_2_percentage / 100;

	//Sat - Planète 2
	var Sat_2 = document.getElementById("Sat_2").value;
	var Sat_2_percentage = document.getElementById("Sat_2_percentage").value;
	var Sat_2_production = production_sat(Temp_2) * Sat_2 * Sat_2_percentage / 100;
	...
	if (Geo < 1){
	var D_2_prod = Math.round(production("D", D_2, Temp_2, NRJ) * D_2_percentage / 100) - Math.round(consumption("CEF", CEF_2) * CEF_2_percentage / 100);
	} else {
	var D_2_prod = (Math.round(production("D", D_2, Temp_2, NRJ) * D_2_percentage / 100) - Math.round(consumption("CEF", CEF_2) * CEF_2_percentage / 100)) + (Math.round(production("D", D_2, Temp_2, NRJ) * D_2_percentage / 100) - Math.round(consumption("CEF", CEF_2) * CEF_2_percentage / 100))/10;
	}
	...
	//Energie
	if (Ing < 1){
	var NRJ_2 = Math.round(CES_2_production + CEF_2_production + Sat_2_production);
	} else {
	var NRJ_2 = Math.round(CES_2_production + CEF_2_production + Sat_2_production + (CES_2_production + CEF_2_production + Sat_2_production)/10);
	}
	...
	if (Geo < 1){
	var M_3_prod = Math.round(production("M", M_3, Temp_3, NRJ) * M_3_percentage / 100);
	} else {
	var M_3_prod = Math.round((production("M", M_3, Temp_3, NRJ) * M_3_percentage / 100) + (production("M", M_3, Temp_3, NRJ) * M_3_percentage / 100)/10);
	}
	...
	if (Geo < 1){
	var C_3_prod = Math.round(production("C", C_3, Temp_3, NRJ) * C_3_percentage / 100);
	} else {
	var C_3_prod = Math.round((production("C", C_3, Temp_3, NRJ) * C_1_percentage / 100) + (production("C", C_3, Temp_3, NRJ) * C_3_percentage / 100)/10);
	}
	...
	var CES_3_production = production("CES", CES_3, Temp_3, NRJ) * CES_3_percentage / 100;

	//CEF - Planète 3
	var CEF_3 = document.getElementById("CEF_3").value;
	var CEF_3_percentage = document.getElementById("CEF_3_percentage").value;
	var CEF_3_production = production("CEF", CEF_3, Temp_3, NRJ) * CEF_3_percentage / 100;

	//Sat - Planète 3
	var Sat_3 = document.getElementById("Sat_3").value;
	var Sat_3_percentage = document.getElementById("Sat_3_percentage").value;
	var Sat_3_production = production_sat(Temp_3) * Sat_3 * Sat_3_percentage / 100;
	...
	if (Geo < 1){
	var D_3_prod = Math.round(production("D", D_3, Temp_3, NRJ) * D_3_percentage / 100) - Math.round(consumption("CEF", CEF_3) * CEF_3_percentage / 100);
	} else {
	var D_3_prod = (Math.round(production("D", D_3, Temp_3, NRJ) * D_3_percentage / 100) - Math.round(consumption("CEF", CEF_3) * CEF_3_percentage / 100)) + (Math.round(production("D", D_3, Temp_3, NRJ) * D_3_percentage / 100) - Math.round(consumption("CEF", CEF_3) * CEF_3_percentage / 100))/10;
	}
	...
	//Energie
	if (Ing < 1){
	var NRJ_3 = Math.round(CES_3_production + CEF_3_production + Sat_3_production);
	} else {
	var NRJ_3 = Math.round(CES_3_production + CEF_3_production + Sat_3_production + (CES_3_production + CEF_3_production + Sat_3_production)/10);
	}
	...
	if (Geo < 1){
	var M_4_prod = Math.round(production("M", M_4, Temp_4, NRJ) * M_4_percentage / 100);
	} else {
	var M_4_prod = Math.round((production("M", M_4, Temp_4, NRJ) * M_4_percentage / 100) + (production("M", M_4, Temp_4, NRJ) * M_4_percentage / 100)/10);
	}
	...
	if (Geo < 1){
	var C_4_prod = Math.round(production("C", C_4, Temp_4, NRJ) * C_4_percentage / 100);
	} else {
	var C_4_prod = Math.round((production("C", C_4, Temp_4, NRJ) * C_4_percentage / 100) + (production("C", C_4, Temp_4, NRJ) * C_4_percentage / 100)/10);
	}
	...
	var CES_4_production = production("CES", CES_4, Temp_4, NRJ) * CES_4_percentage / 100;

	//CEF - Planète 4
	var CEF_4 = document.getElementById("CEF_4").value;
	var CEF_4_percentage = document.getElementById("CEF_4_percentage").value;
	var CEF_4_production = production("CEF", CEF_4, Temp_4, NRJ) * CEF_4_percentage / 100;

	//Sat - Planète 4
	var Sat_4 = document.getElementById("Sat_4").value;
	var Sat_4_percentage = document.getElementById("Sat_4_percentage").value;
	var Sat_4_production = production_sat(Temp_4) * Sat_4 * Sat_4_percentage / 100;
	...
	if (Geo < 1){
	var D_4_prod = Math.round(production("D", D_4, Temp_4, NRJ) * D_4_percentage / 100) - Math.round(consumption("CEF", CEF_4) * CEF_4_percentage / 100);
	} else {
	var D_4_prod = (Math.round(production("D", D_4, Temp_4, NRJ) * D_4_percentage / 100) - Math.round(consumption("CEF", CEF_4) * CEF_4_percentage / 100)) + (Math.round(production("D", D_4, Temp_4, NRJ) * D_4_percentage / 100) - Math.round(consumption("CEF", CEF_4) * CEF_4_percentage / 100))/10;
	}
	...
	//Energie
	if (Ing < 1){
	var NRJ_4 = Math.round(CES_4_production + CEF_4_production + Sat_4_production);
	} else {
	var NRJ_4 = Math.round(CES_4_production + CEF_4_production + Sat_4_production + (CES_4_production + CEF_4_production + Sat_4_production)/10);
	}
	...
	if (Geo < 1){
	var M_5_prod = Math.round(production("M", M_5, Temp_5, NRJ) * M_5_percentage / 100);
	} else {
	var M_5_prod = Math.round((production("M", M_5, Temp_1, NRJ) * M_5_percentage / 100) + (production("M", M_5, Temp_5, NRJ) * M_5_percentage / 100)/10);
	}
	...
	if (Geo < 1){
	var C_5_prod = Math.round(production("C", C_5, Temp_5, NRJ) * C_5_percentage / 100);
	} else {
	var C_5_prod = Math.round((production("C", C_5, Temp_5, NRJ) * C_5_percentage / 100) + (production("C", C_5, Temp_5, NRJ) * C_5_percentage / 100)/10);
	}
	...
	var CES_5_production = production("CES", CES_5, Temp_5, NRJ) * CES_5_percentage / 100;

	//CEF - Planète 5
	var CEF_5 = document.getElementById("CEF_5").value;
	var CEF_5_percentage = document.getElementById("CEF_5_percentage").value;
	var CEF_5_production = production("CEF", CEF_5, Temp_5, NRJ) * CEF_5_percentage / 100;

	//Sat - Planète 5
	var Sat_5 = document.getElementById("Sat_5").value;
	var Sat_5_percentage = document.getElementById("Sat_5_percentage").value;
	var Sat_5_production = production_sat(Temp_5) * Sat_5 * Sat_5_percentage / 100;
	...
	if (Geo < 1){
	var D_5_prod = Math.round(production("D", D_5, Temp_5, NRJ) * D_5_percentage / 100) - Math.round(consumption("CEF", CEF_5) * CEF_5_percentage / 100);
	} else {
	var D_5_prod = (Math.round(production("D", D_5, Temp_5, NRJ) * D_5_percentage / 100) - Math.round(consumption("CEF", CEF_5) * CEF_5_percentage / 100)) + (Math.round(production("D", D_5, Temp_5, NRJ) * D_5_percentage / 100) - Math.round(consumption("CEF", CEF_5) * CEF_5_percentage / 100))/10;
	}
	...
	//Energie
	if (Ing < 1){
	var NRJ_5 = Math.round(CES_5_production + CEF_5_production + Sat_5_production);
	} else {
	var NRJ_5 = Math.round(CES_5_production + CEF_5_production + Sat_5_production + (CES_5_production + CEF_5_production + Sat_5_production)/10);
	}
	...
	if (Geo < 1){
	var M_6_prod = Math.round(production("M", M_6, Temp_6, NRJ) * M_6_percentage / 100);
	} else {
	var M_6_prod = Math.round((production("M", M_6, Temp_6, NRJ) * M_6_percentage / 100) + (production("M", M_6, Temp_6, NRJ) * M_6_percentage / 100)/10);
	}
	...
	if (Geo < 1){
	var C_6_prod = Math.round(production("C", C_6, Temp_6, NRJ) * C_6_percentage / 100);
	} else {
	var C_6_prod = Math.round((production("C", C_6, Temp_6, NRJ) * C_6_percentage / 100) + (production("C", C_6, Temp_6, NRJ) * C_6_percentage / 100)/10);
	}
	...
	var CES_6_production = production("CES", CES_6, Temp_6, NRJ) * CES_6_percentage / 100;

	//CEF - Planète 6
	var CEF_6 = document.getElementById("CEF_6").value;
	var CEF_6_percentage = document.getElementById("CEF_6_percentage").value;
	var CEF_6_production = production("CEF", CEF_6, Temp_6, NRJ) * CEF_6_percentage / 100;

	//Sat - Planète 6
	var Sat_6 = document.getElementById("Sat_6").value;
	var Sat_6_percentage = document.getElementById("Sat_6_percentage").value;
	var Sat_6_production = production_sat(Temp_6) * Sat_6 * Sat_6_percentage / 100;
	...
	if (Geo < 1){
	var D_6_prod = Math.round(production("D", D_6, Temp_6, NRJ) * D_6_percentage / 100) - Math.round(consumption("CEF", CEF_6) * CEF_6_percentage / 100);
	} else {
	var D_6_prod = (Math.round(production("D", D_6, Temp_6, NRJ) * D_6_percentage / 100) - Math.round(consumption("CEF", CEF_6) * CEF_6_percentage / 100)) + (Math.round(production("D", D_6, Temp_6, NRJ) * D_6_percentage / 100) - Math.round(consumption("CEF", CEF_6) * CEF_6_percentage / 100))/10;
	}
	...
	//Energie
	if (Ing < 1){
	var NRJ_6 = Math.round(CES_6_production + CEF_6_production + Sat_6_production);
	} else {
	var NRJ_6 = Math.round(CES_6_production + CEF_1_production + Sat_6_production + (CES_6_production + CEF_6_production + Sat_6_production)/10);
	}
	...
	if (Geo < 1){
	var M_7_prod = Math.round(production("M", M_7, Temp_7, NRJ) * M_7_percentage / 100);
	} else {
	var M_7_prod = Math.round((production("M", M_7, Temp_7, NRJ) * M_7_percentage / 100) + (production("M", M_7, Temp_7, NRJ) * M_7_percentage / 100)/10);
	}
	...
	if (Geo < 1){
	var C_7_prod = Math.round(production("C", C_7, Temp_7, NRJ) * C_7_percentage / 100);
	} else {
	var C_7_prod = Math.round((production("C", C_7, Temp_7, NRJ) * C_7_percentage / 100) + (production("C", C_7, Temp_7, NRJ) * C_7_percentage / 100)/10);
	}
	...
	var CES_7_production = production("CES", CES_7, Temp_7, NRJ) * CES_7_percentage / 100;

	//CEF - Planète 7
	var CEF_7 = document.getElementById("CEF_7").value;
	var CEF_7_percentage = document.getElementById("CEF_7_percentage").value;
	var CEF_7_production = production("CEF", CEF_7, Temp_7, NRJ) * CEF_7_percentage / 100;

	//Sat - Planète 7
	var Sat_7 = document.getElementById("Sat_7").value;
	var Sat_7_percentage = document.getElementById("Sat_7_percentage").value;
	var Sat_7_production = production_sat(Temp_7) * Sat_7 * Sat_7_percentage / 100;
	...
	if (Geo < 1){
	var D_7_prod = Math.round(production("D", D_7, Temp_7, NRJ) * D_7_percentage / 100) - Math.round(consumption("CEF", CEF_7) * CEF_7_percentage / 100);
	} else {
	var D_7_prod = (Math.round(production("D", D_7, Temp_7, NRJ) * D_7_percentage / 100) - Math.round(consumption("CEF", CEF_7) * CEF_7_percentage / 100)) + (Math.round(production("D", D_7, Temp_7, NRJ) * D_7_percentage / 100) - Math.round(consumption("CEF", CEF_7) * CEF_7_percentage / 100))/10;
	}
	...
	//Energie
	if (Ing < 1){
	var NRJ_7 = Math.round(CES_7_production + CEF_7_production + Sat_7_production);
	} else {
	var NRJ_7 = Math.round(CES_7_production + CEF_7_production + Sat_7_production + (CES_7_production + CEF_7_production + Sat_7_production)/10);
	}
	...
	if (Geo < 1){
	var M_8_prod = Math.round(production("M", M_8, Temp_8, NRJ) * M_8_percentage / 100);
	} else {
	var M_8_prod = Math.round((production("M", M_8, Temp_8, NRJ) * M_8_percentage / 100) + (production("M", M_8, Temp_8, NRJ) * M_8_percentage / 100)/10);
	}
	...
	if (Geo < 1){
	var C_8_prod = Math.round(production("C", C_8, Temp_8, NRJ) * C_8_percentage / 100);
	} else {
	var C_8_prod = Math.round((production("C", C_8, Temp_8, NRJ) * C_8_percentage / 100) + (production("C", C_8, Temp_8, NRJ) * C_8_percentage / 100)/10);
	}
	...
	var CES_8_production = production("CES", CES_8, Temp_8, NRJ) * CES_8_percentage / 100;

	//CEF - Planète 8
	var CEF_8 = document.getElementById("CEF_8").value;
	var CEF_8_percentage = document.getElementById("CEF_8_percentage").value;
	var CEF_8_production = production("CEF", CEF_8, Temp_8, NRJ) * CEF_8_percentage / 100;

	//Sat - Planète 8
	var Sat_8 = document.getElementById("Sat_8").value;
	var Sat_8_percentage = document.getElementById("Sat_8_percentage").value;
	var Sat_8_production = production_sat(Temp_8) * Sat_8 * Sat_8_percentage / 100;
	...
	if (Geo < 1){
	var D_8_prod = Math.round(production("D", D_8, Temp_8, NRJ) * D_8_percentage / 100) - Math.round(consumption("CEF", CEF_8) * CEF_8_percentage / 100);
	} else {
	var D_8_prod = (Math.round(production("D", D_8, Temp_8, NRJ) * D_8_percentage / 100) - Math.round(consumption("CEF", CEF_8) * CEF_8_percentage / 100)) + (Math.round(production("D", D_8, Temp_8, NRJ) * D_8_percentage / 100) - Math.round(consumption("CEF", CEF_8) * CEF_8_percentage / 100))/10;
	}
	...
	//Energie
	if (Ing < 1){
	var NRJ_8 = Math.round(CES_8_production + CEF_8_production + Sat_8_production);
	} else {
	var NRJ_8 = Math.round(CES_8_production + CEF_8_production + Sat_8_production + (CES_8_production + CEF_8_production + Sat_8_production)/10);
	}
	...
	if (Geo < 1){
	var M_9_prod = Math.round(production("M", M_9, Temp_9, NRJ) * M_9_percentage / 100);
	} else {
	var M_9_prod = Math.round((production("M", M_9, Temp_9, NRJ) * M_9_percentage / 100) + (production("M", M_9, Temp_9, NRJ) * M_9_percentage / 100)/10);
	}
	...
	if (Geo < 1){
	var C_9_prod = Math.round(production("C", C_9, Temp_9, NRJ) * C_9_percentage / 100);
	} else {
	var C_9_prod = Math.round((production("C", C_9, Temp_9, NRJ) * C_9_percentage / 100) + (production("C", C_9, Temp_9, NRJ) * C_9_percentage / 100)/10);
	}
	...
	var CES_9_production = production("CES", CES_9, Temp_9, NRJ) * CES_9_percentage / 100;

	//CEF - Planète 9
	var CEF_9 = document.getElementById("CEF_9").value;
	var CEF_9_percentage = document.getElementById("CEF_9_percentage").value;
	var CEF_9_production = production("CEF", CEF_9, Temp_9, NRJ) * CEF_9_percentage / 100;

	//Sat - Planète 9
	var Sat_9 = document.getElementById("Sat_9").value;
	var Sat_9_percentage = document.getElementById("Sat_9_percentage").value;
	var Sat_9_production = production_sat(Temp_9) * Sat_9 * Sat_9_percentage / 100;
	...
	if (Geo < 1){
	var D_9_prod = Math.round(production("D", D_9, Temp_9, NRJ) * D_9_percentage / 100) - Math.round(consumption("CEF", CEF_9) * CEF_9_percentage / 100);
	} else {
	var D_9_prod = (Math.round(production("D", D_9, Temp_9, NRJ) * D_9_percentage / 100) - Math.round(consumption("CEF", CEF_9) * CEF_9_percentage / 100)) + (Math.round(production("D", D_9, Temp_9, NRJ) * D_9_percentage / 100) - Math.round(consumption("CEF", CEF_9) * CEF_9_percentage / 100))/10;
	}
	...
	//Energie
	if (Ing < 1){
	var NRJ_9 = Math.round(CES_9_production + CEF_9_production + Sat_9_production);
	} else {
	var NRJ_9 = Math.round(CES_9_production + CEF_9_production + Sat_9_production + (CES_9_production + CEF_9_production + Sat_9_production)/10);
	}
...
// Sat planete
	...
	var sat_lune_1 = document.getElementById("sat_lune_1").value;
	var sat_pts_1 = Math.round(Sat_1*2.5+sat_lune_1*2.5);
	document.getElementById("sat_pts_1").innerHTML = "<font color='lime'>"+sat_pts_1+"</font>";
	var sat_lune_2 = document.getElementById("sat_lune_2").value;
	var sat_pts_2 = Math.round(Sat_2*2.5+sat_lune_2*2.5);
	document.getElementById("sat_pts_2").innerHTML = "<font color='lime'>"+sat_pts_2+"</font>";
	var sat_lune_3 = document.getElementById("sat_lune_3").value;
	var sat_pts_3 = Math.round(Sat_3*2.5+sat_lune_3*2.5);
	document.getElementById("sat_pts_3").innerHTML = "<font color='lime'>"+sat_pts_3+"</font>";
	var sat_lune_4 = document.getElementById("sat_lune_4").value;
	var sat_pts_4 = Math.round(Sat_4*2.5+sat_lune_4*2.5);
	document.getElementById("sat_pts_4").innerHTML = "<font color='lime'>"+sat_pts_4+"</font>";
	var sat_lune_5 = document.getElementById("sat_lune_5").value;
	var sat_pts_5 = Math.round(Sat_5*2.5+sat_lune_5*2.5);
	document.getElementById("sat_pts_5").innerHTML = "<font color='lime'>"+sat_pts_5+"</font>";
	var sat_lune_6 = document.getElementById("sat_lune_6").value;
	var sat_pts_6 = Math.round(Sat_6*2.5+sat_lune_6*2.5);
	document.getElementById("sat_pts_6").innerHTML = "<font color='lime'>"+sat_pts_6+"</font>";
	var sat_lune_7 = document.getElementById("sat_lune_7").value;
	var sat_pts_7 = Math.round(Sat_7*2.5+sat_lune_7*2.5);
	document.getElementById("sat_pts_7").innerHTML = "<font color='lime'>"+sat_pts_7+"</font>";
	var sat_lune_8 = document.getElementById("sat_lune_8").value;
	var sat_pts_8 = Math.round(Sat_8*2.5+sat_lune_8*2.5);
	document.getElementById("sat_pts_8").innerHTML = "<font color='lime'>"+sat_pts_8+"</font>";
	var sat_lune_9 = document.getElementById("sat_lune_9").value;
	var sat_pts_9 = Math.round(Sat_9*2.5+sat_lune_9*2.5);
	document.getElementById("sat_pts_9").innerHTML = "<font color='lime'>"+sat_pts_9+"</font>";
	
	var total_sat_pts = sat_pts_1+sat_pts_2+sat_pts_3+sat_pts_4+sat_pts_5+sat_pts_6+sat_pts_7+sat_pts_8+sat_pts_9;
	
	document.getElementById("total_sat_pts").innerHTML = total_sat_pts;
	
	
	document.getElementById("total_pts_1").innerHTML = Math.round((total_pts_1 + lune_pts_1)/1000)+sat_pts_1;
	document.getElementById("total_pts_2").innerHTML = Math.round((total_pts_2 + lune_pts_2)/1000)+sat_pts_2;
	document.getElementById("total_pts_3").innerHTML = Math.round((total_pts_3 + lune_pts_3)/1000)+sat_pts_3;
	document.getElementById("total_pts_4").innerHTML = Math.round((total_pts_4 + lune_pts_4)/1000)+sat_pts_4;
	document.getElementById("total_pts_5").innerHTML = Math.round((total_pts_5 + lune_pts_5)/1000)+sat_pts_5;
	document.getElementById("total_pts_6").innerHTML = Math.round((total_pts_6 + lune_pts_6)/1000)+sat_pts_6;
	document.getElementById("total_pts_7").innerHTML = Math.round((total_pts_7 + lune_pts_7)/1000)+sat_pts_7;
	document.getElementById("total_pts_8").innerHTML = Math.round((total_pts_8 + lune_pts_8)/1000)+sat_pts_8;
	document.getElementById("total_pts_9").innerHTML = Math.round((total_pts_9 + lune_pts_9)/1000)+sat_pts_9;

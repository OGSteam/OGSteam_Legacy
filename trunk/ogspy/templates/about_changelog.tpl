<table width="70%" style="text-align:center;margin-left:auto;margin-right:auto;">
<tr>
	<td style="text-align:center;margin-left:auto;margin-right:auto;" class="c" colspan="2">
		<span style="color:Yellow;">{ogsteam_website}</span>
		<a href="http://www.ogsteam.fr" onclick="window.open(this.href);return false;">http://www.ogsteam.fr</a><br />
		<span style="color:Yellow;">{ogsteam_ircchan}</span>
		<a href='irc://irc.ogamenet.net:6667/ogstratege'>irc://irc.ogamenet.net:6667/ogsteam</a>
	</td>
</tr>
<tr>
	<td class="c" style="width:50px;">Version</td>
	<td class="c">Description</td>
</tr>
<tr>
	<th>4.0</th>
	<th style="text-align:left">
		- [add] Internationalisation d'OGSpy. Pack de language disponible sur <a href="http://www.ogsteam.fr" onclick="window.open(this.href);return false;">le site OGSteam</a><br />
		- [add] Permission des groupes : possibilité d'interdire des mods ou des groupes de mods<br />
		- [add] L'admin peut définir jusqu'à 9 couleurs associées à des noms de joueurs ou d'alliances<br />
		- [add] Messagerie interne.<br />
		- [add] Champ "nom in-game" dans le profil et position de la planète mère<br />
		- [add] Possibilité de se déplacer dans la vue galaxie au clavier<br />
		- [add] Affichage des phalanges enregistrées dans les Empires des membres comme "Phalanges Amies" dans la vue galaxie<br />
		- [add] Système de template.<br />
		- [add] Gestion des modules. Intégration du module "AutoUpdate" directement dans la partie Administration.<br/>
		- [mod] Gestion des modules. Changer le texte du menu, créer des catégories et ajouter un lien admin direct<br />
		- [mod] Gestion des groupes. Plus rapide (inspiré de l'addon de Unibozu)<br />
		- [mod] Harmonisation de l'affichage des MIP, Phalanges Amies et Phalanges Enemies<br />
		- [mod] Espace Alliance : Possibilité de chercher alliance(s) et/ou joueur(s)<br />
		- [mod] Alliances cachées: L'admin choisi une couleur ou le texte clignotant<br />
		- [mod] Revue de la gestion des RE.<br />
		- [mod] Ne pas prendre en compte le terraformeur ou la base lunaire sur le total de cases disponibles<br />

...
<tr align="center">
	...
	<td class="c" width="50"><a title="Chargées via OGS et les toolbars">OGS&nbsp;<img src='images/desc.png'></a></td>
	...
	<td class="c" width="50"><a title="Chargés via OGS et les toolbars">OGS&nbsp;<img src='images/desc.png'></a></td>
...
?>
<tr>
	<td colspan="12">(*) connecté sur le serveur<br />(**) connecté avec OGS ou les toolbars</td>
</tr>
<?php
}
echo "</table>";

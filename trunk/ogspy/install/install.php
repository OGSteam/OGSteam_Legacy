...
function generate_id($sgbd_server, $sgbd_dbname, $sgbd_username, $sgbd_password, $sgbd_tableprefix, $sgbd_num_of_galaxies, $sgbd_num_of_systems) {
	...
	echo "<h3 align='center'><font color='yellow'>Installation du serveur OGSpy 3.05 effectuée avec succès</font></h3>";
	echo "<center>";
...
<tr>
	<td align="center">
		<table width="800">
		<tr>
			<td colspan="2" align="center"><font size="3"><b>Bienvenue à l'installation d'OGSpy version 3.05</b></font></td>
		</tr>
		<tr>

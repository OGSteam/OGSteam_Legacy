...
<?php
$first = array("general_pts" => -1, "fleet_pts" => -1, "defenses_pts" => -1, "mines_pts" => -1, "research_pts" => -1,);
$last = array("general_pts" => 0, "fleet_pts" => 0, "defenses_pts" => 0, "mines_pts" => 0, "research_pts" => 0, "general_rank" => 0, "fleet_rank" => 0, "defenses_rank" => 0, "mines_rank" => 0, "research_rank" => 0);
$tab_rank = "";
...
echo "<tr><td class='c' colspan='2'>Vaisseaux</td></tr>";
...
echo "<tr><td class='c' colspan='2'>Recherches</td></tr>";
...
<br />
		...
		<tr>
			...
			<td class="c" colspan="2">Pts Vaisseaux</td>
			<td class="c" colspan="2">Pts Mines</td>
			<td class="c" colspan="2">Pts Défenses</td>
			<td class="c" colspan="2">Pts Recherches</td>
		</tr>
<?php
echo $tab_rank;
echo "\t\t"."<tr>"."\n";

...
<tr>
	<th><a>Panneau de production énergétique solaire</a></th>
<?php
for ($i=1 ; $i<=9 ; $i++) {
	$CES = $user_building[$i]["CES"];
	if ($CES == "") $CES = "&nbsp;";
...
<tr>
	<th><a>Laboratoire de recherches</a></th>
<?php
for ($i=1 ; $i<=9 ; $i++) {
...
<tr>
	<th><a>Réacteur à combustion interne</a></th>
<?php
for ($i=1 ; $i<=9 ; $i++) {
	$Lab = $user_building[$i]["Lab"];
	$RC = "&nbsp;";
...
<tr>
	<th><a>Canon à protons</a></th>
<?php
for ($i=$start ; $i<=$start+8 ; $i++) {
	$CG = $user_defence[$i]["CP"];
	if ($CG == "") $CG = "&nbsp;";

...
if(isset($pub_graph) && $pub_graph == "barre") {
	require_once("view/graphic_barre.php");
	exit();
}
...
function plus_rank_date($ranking, $rank_date) {
	...
	switch($ranking) {
		...
		case "rank_player_fleet":
			...
			break;
		case "rank_player_defenses":
			$table = TABLE_RANK_PLAYER_DEFENSES;
			break;
		case "rank_player_mines":
			$table = TABLE_RANK_PLAYER_MINES;
			break;
		...
		case "rank_ally_fleet":
			...
			break;
		case "rank_ally_defenses":
			$table = TABLE_RANK_ALLY_DEFENSES;
			break;
		case "rank_ally_mines":
			$table = TABLE_RANK_ALLY_MINES;
			break;
		default:
...
<tr>
	<td valign="top">
		...
		<input type="hidden" name="subaction" value="advenced">
		<tr>

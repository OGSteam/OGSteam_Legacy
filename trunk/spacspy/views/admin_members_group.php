...
<tr>
	<td valign="top" width="450">
		...
		<tr>
			<td class="c" width="300">Droits serveur SpacSpy (et FoxGame)</td>
		...
		<tr>
			...
			<th><input name="server_set_rc" type="checkbox" value="1" <?php echo ($usergroup_info["server_set_spy"]) ? "checked" : ""?>></th>
		</tr>
		<tr>
	...
	<td valign="top" width="450">
		<table align="center" width="100%">
		<tr>
			<td class="c" width="300">Droits clients externes (spacecon Stratège, toolbars)</td>
			<td class="c" width="150">Permissions</td>
		</tr>
		<tr>
			<th>Connexion serveur</th>
			<th><input name="spacs_connection" type="checkbox" value="1" <?php echo ($usergroup_info["spacs_connection"]) ? "checked" : ""?>></th>
		</tr>
		<tr>
			<th>Importation système solaire</th>
			<th><input name="spacs_set_system" type="checkbox" value="1" <?php echo ($usergroup_info["spacs_set_system"]) ? "checked" : ""?>></th>
		</tr>
		<tr>
			<th>Exportation système solaire</th>
			<th><input name="spacs_get_system" type="checkbox" value="1" <?php echo ($usergroup_info["spacs_get_system"]) ? "checked" : ""?>></th>
		</tr>
		<tr>
			<th>Importation rapport espionnage</th>
			<th><input name="spacs_set_spy" type="checkbox" value="1" <?php echo ($usergroup_info["spacs_set_spy"]) ? "checked" : ""?>></th>
		</tr>
		<tr>
			<th>Exportation rapport espionnage</th>
			<th><input name="spacs_get_spy" type="checkbox" value="1" <?php echo ($usergroup_info["spacs_get_spy"]) ? "checked" : ""?>></th>
		</tr>
		<tr>
			<th>Importation classement</th>
			<th><input name="spacs_set_ranking" type="checkbox" value="1" <?php echo ($usergroup_info["spacs_set_ranking"]) ? "checked" : ""?>></th>
		</tr>
		<tr>
			<th>Exportation classement</th>
			<th><input name="spacs_get_ranking" type="checkbox" value="1" <?php echo ($usergroup_info["spacs_get_ranking"]) ? "checked" : ""?>></th>
		</tr>
		</table>
	</td>
</tr>

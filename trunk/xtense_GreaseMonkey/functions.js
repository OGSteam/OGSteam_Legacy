function displayOption(id){
	if(id=="Xtense_serveurs"){
		...
		document.getElementById("Xtense_table_serveurs").style.value=document.getElementById(id).style.value.replace("color: orange","color: white");
		...
		document.getElementById("Xtense_table_serveurs").style.value=document.getElementById(id).style.value.replace("color: white","color: orange");
		document.getElementById("Xtense_options").style.display="none";
		document.getElementById("Xtense_about").style.display="none";

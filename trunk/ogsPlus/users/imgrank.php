<?php    
  ...
  { 
 $rvb_rank_r_1=$result["rvb_rank_r_1"];
 $rvb_rank_r_2=$result["rvb_rank_r_2"]; 
 $rvb_rank_r_3=$result["rvb_rank_r_3"]; 
 $rvb_rank_r_4=$result["rvb_rank_r_4"]; 
 $rvb_rank_v_1=$result["rvb_rank_v_1"]; 
 $rvb_rank_v_2=$result["rvb_rank_v_2"]; 
 $rvb_rank_v_3=$result["rvb_rank_v_3"]; 
 $rvb_rank_v_4=$result["rvb_rank_v_4"]; 
 $rvb_rank_b_1=$result["rvb_rank_b_1"]; 
 $rvb_rank_b_2=$result["rvb_rank_b_2"]; 
 $rvb_rank_b_3=$result["rvb_rank_b_3"]; 
 $rvb_rank_b_4=$result["rvb_rank_b_4"]; 
 ...
 $rank_bg=$result["rank_bg"]; 
 } mysql_close();
 
?>
<br>
<h2><?php echo $lng_bb_aa ?></h2>
<form action="index.php?lng=<?php echo $lng ?>&page=majimgrank.php" method="post" dir="ltr">
<?php
if($rank_bg ==  0){
...
if("$rvb_rank_r_1$rvb_rank_v_1$rvb_rank_b_1$rvb_rank_r_3$rvb_rank_v_3$rvb_rank_b_3$r_txt_rank$v_txt_rank$b_txt_rank$r_chiff_rank$v_chiff_rank$b_chiff_rank" == 240240240240240240000000 AND "$rvb_rank_r_2$rvb_rank_v_2$rvb_rank_b_2$rvb_rank_r_4$rvb_rank_v_4$rvb_rank_b_4" == 255255255255255255){

echo "<input type=\"checkbox\" name=\"CHK1\" value=\"ON\" checked=\"checked\"> <font color=\"#C0C0C0\">$lng_bc_af

</font><br>";

}else{

echo "<input type=\"checkbox\" name=\"CHK1\" value=\"ON\"> <font color=\"#C0C0C0\">$lng_bc_af
...
<input type="text" name="CC12" size="3" value="<?php echo $rvb_rank_b_4; ?>"><br><br />

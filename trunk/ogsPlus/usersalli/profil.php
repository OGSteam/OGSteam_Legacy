...
<p align="center"><?php echo $lng_bi_aa ?><br>
<input type="text" value="<?php echo $nom; ?>" disabled="disabled" size="25">

<br><br><?php echo $lng_bi_ab ?><br>
<input type="text" value="<?php echo $uni; ?>" disabled="disabled" size="25">

<br><br><?php echo $lng_bi_ac ?><br>
<input type="text" name="a" value="<?php echo $alli; ?>" size="25">

<br><br><?php echo $lng_bi_ad ?><br>
<input type="text" name="b" value="<?php echo $tag; ?>" size="25">

...
&nbsp;</p>
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="533" height="30" id="AutoNumber1" bordercolorlight="#000000" bordercolordark="#000000" bgcolor="#FFFFFF">
      ...
      <b>
      <font face="Arial" size="2" color="#000000"><?php echo $lng_bn_aa ?></font></b></td>
      ...
      <input type="text" size="15" name="m" value="<?php echo $mbrs; ?>" /></b></font></td>
      <td width="133" height="37" align="center" bordercolorlight="#000000" bordercolordark="#000000" bgcolor="#C0C0C0">
      <font face="Arial" size="1" color="#FFFFFF"><b>
      </b></font></td>
      <td width="133" height="37" align="center" bordercolorlight="#000000" bordercolordark="#000000" bgcolor="#C0C0C0">
    ...
    <tr>
      <td width="132" height="37" align="center" bordercolorlight="#000000" bordercolordark="#000000" bgcolor="#C0C0C0">
      <b>
      <font face="Arial" size="2" color="#000000"><?php echo $lng_bn_ag ?></font></b></td>
      <td width="133" height="37" align="center" bordercolorlight="#000000" bordercolordark="#000000" bgcolor="#C0C0C0">
      <font face="Arial" size="1" color="#FFFFFF"><b>
      ...
      <tr>
      <td width="132" height="37" align="center" bordercolorlight="#000000" bordercolordark="#000000" bgcolor="#808080"><b>
      <font face="Arial" size="2" color="#FFFFFF">Points / Membres</font></b></td>
      <td width="133" height="37" align="center" bordercolorlight="#000000" bordercolordark="#000000" bgcolor="#808080">
      <font face="Arial" size="1" color="#FFFFFF"><b>
      <input type="text" size="15" name="j" value="<?php echo $tmpts; ?>" /></b></font></td>
      <td width="133" height="37" align="center" bordercolorlight="#000000" bordercolordark="#000000" bgcolor="#808080">
      <font face="Arial" size="1" color="#FFFFFF"><b>
      <input type="text" size="15" name="k" value="<?php echo $tmvaiss; ?>" /></b></font></td>
      <td width="133" height="37" align="center" bordercolorlight="#000000" bordercolordark="#000000" bgcolor="#808080">
      <font face="Arial" size="1" color="#FFFFFF"><b>
      <input type="text" size="15" name="l" value="<?php echo $tmrech; ?>" /></b></font></td>
    </tr>
  </table>
  </center>
</div>

...
##
## Structure de la table `ogspy_history`
##

CREATE TABLE `ogspy_history` (
	`id_player` INT( 5 ) NOT NULL ,
	`id_ally` INT( 5 ) NOT NULL ,
	`name_ally` VARCHAR( 255 ) NOT NULL ,
...
INSERT INTO `ogspy_ally` VALUES (0, '');
...
INSERT INTO `ogspy_player` VALUES (0, '', 0);
##########################################################
...
CREATE TABLE ogspy_mod (
	...
	admin_only TEXT NOT NULL COMMENT 'Lien du panneau admin du mod, pour affichage dans gestion des mods',
	PRIMARY KEY (id),
...
##
## Structure de la table `ogspy_mod_cat`
##

CREATE TABLE `ogspy_mod_cat` (
	`id` int(11) NOT NULL auto_increment,
	`title` varchar(255) NOT NULL COMMENT 'Nom de la categorie',
	`menu` varchar(255) NOT NULL COMMENT 'Titre dans le menu',
	`position` int(11) NOT NULL default '-1',
...
INSERT IGNORE INTO `ogspy_mod_cat` (title, menu, position, active) VALUES ('Admin','Administration','10','1');
...
CREATE TABLE ogspy_rank_player_fleet (
	...
	sender_id int(11) NOT NULL default '0',
	PRIMARY KEY (rank,datadate),
	KEY datadate (datadate,id_player),
...
CREATE TABLE ogspy_universe (
	galaxy smallint(3) NOT NULL default '0',
...
CREATE TABLE ogspy_universe_temporary (
	id_player varchar(64) NOT NULL default '',
	`status` varchar(5) NOT NULL,
...
CREATE TABLE ogspy_user (
	...
	ally_stat_name varchar(50) NOT NULL default '',
...
CREATE TABLE ogspy_user_building (
	...
	planet_name varchar(64) NOT NULL default '',
...
##
## Structure de la table `ogspy_user_fleet`
##

CREATE TABLE `ogspy_user_fleet` (
	`user_id` int(11) NOT NULL DEFAULT '0',
	`planet_id` int(11) NOT NULL DEFAULT '0',
...
##
## Structure de la table `ogspy_mod_restrict`
##

CREATE TABLE `ogspy_mod_restrict` (
...
INSERT INTO `ogspy_config` VALUES ('friendly_phalanx', '1');
...
INSERT INTO `ogspy_config` VALUES ('scolor_count', '2');
INSERT INTO `ogspy_config` VALUES ('scolor_text', ' -- _|_ -- ');
INSERT INTO `ogspy_config` VALUES ('scolor_type', 'J_A');
INSERT INTO `ogspy_config` VALUES ('scolor_color', 'Green_Green');
INSERT INTO `ogspy_config` VALUES ('ally_protection_color', '');
INSERT INTO `ogspy_config` VALUES ('log_langerror', '0');
##########################################################
...
CREATE TABLE `ogspy_parsedspy` (
	...
	`galaxy` smallint(3) NOT NULL default '0',
	`system` smallint(3) NOT NULL default '0',
	`row` smallint(3) NOT NULL default '0',
...
CREATE TABLE `ogspy_round_attack` (
	...
	`row` smallint(3) NOT NULL default '1',
	`Armes` smallint(2) NOT NULL default '-1',
	`Bouclier` smallint(2) NOT NULL default '-1',
	`Protection` smallint(2) NOT NULL default '-1',
	`PT` int(11) NOT NULL default '-1',
...
##
## Structure de la table `ogspy_mp`
##

CREATE TABLE `ogspy_mp` (
	`id` int(11) NOT NULL auto_increment,

#
# $Id: mysql_41_schema.sql,v 1.37 2007/07/31 20:27:39 davidmj Exp $
#
...
CREATE TABLE phpbb_users (
	...
	last24 int(11) NOT NULL default '0',
	...
	meteo_name varchar(50) collate utf8_bin default NULL,
	user_country_flag varchar(50) collate utf8_bin default NULL,
	user_admin enum('0','1') collate utf8_bin NOT NULL default '0',
	user_coadmin enum('0','1') collate utf8_bin NOT NULL default '0',
	user_active enum('0','1') collate utf8_bin NOT NULL default '0',
	user_galaxy enum('1','2','3','4','5','6','7','8','9') collate utf8_bin NOT NULL default '1',
	...
	user_skin varchar(255) collate utf8_bin NOT NULL default '',
	user_stat_name varchar(50) collate utf8_bin NOT NULL default '',
	management_user enum('0','1') collate utf8_bin NOT NULL default '0',
	management_ranking enum('0','1') collate utf8_bin NOT NULL default '0',
	disable_ip_check enum('0','1') collate utf8_bin NOT NULL default '0',
	PRIMARY KEY (user_id),

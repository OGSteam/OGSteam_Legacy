...
<tr>
	<th colspan="2">
		<select name="perimeter">
			<option value="1" <?php if ($perimeter == 1) echo "selected";?>>Galaxie 1</option>
			<option value="2" <?php if ($perimeter == 2) echo "selected";?>>Galaxie 2</option>
			<option value="3" <?php if ($perimeter == 3) echo "selected";?>>Galaxie 3</option>
			<option value="4" <?php if ($perimeter == 4) echo "selected";?>>Galaxie 4</option>
			<option value="5" <?php if ($perimeter == 5) echo "selected";?>>Galaxie 5</option>
			<option value="6" <?php if ($perimeter == 6) echo "selected";?>>Galaxie 6</option>
			<option value="7" <?php if ($perimeter == 7) echo "selected";?>>Galaxie 7</option>
			<option value="8" <?php if ($perimeter == 8) echo "selected";?>>Galaxie 8</option>
			<option value="9" <?php if ($perimeter == 9) echo "selected";?>>Galaxie 9</option>

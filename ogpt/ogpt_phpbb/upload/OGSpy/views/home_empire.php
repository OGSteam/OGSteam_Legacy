...
<?php
if(isset($pub_alert_empire) && $pub_alert_empire) echo 'message("Pense à renseigner, si besoin est, les noms de planetes et les temperatures\nqui ne peuvent pas être récupérés par la page empire d\'Ogame.");';
...
<table width="100%">
<tr>
	<td class="c" colspan="10">Coller les informations et sélectionnez la planète sélectionnée</td>
</tr>
<tr>
<?php
if ($view == "planets") {
...
<tr>
	...
	<input name="typedata" id="building" value="B" type="radio" onclick="if(!select_planet) message('Vous devez selectionner une planete');"> <a>Bâtiments</a><input name="typedata" value="D" type="radio" onclick="if(!select_planet) message('Vous devez selectionner une planete');"> <a>Défenses</a>

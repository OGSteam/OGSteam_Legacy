...
switch ($pub_id_message) {
	...
	$message .= "<font color='lime'><b>Création du compte de <a>".$user_info[0]["username"]."</a> réussie</b></font><br />";
	...
	list($user_id, $password) = explode("¤", $pub_info);
	$user_info = user_get($user_id);
	$message .= "<font color='lime'><b>Génération du nouveau mot de passe de <a>".$user_info[0]["username"]."</a> réussie</b></font><br />";
	...
	$message .= "<i>Le pseudo est incorrecte</i></a>";
	$action = "action=administration&subaction=member";
	break;
	...
	$message .= "<font color='lime'><b>Modification du profil de <a>".$user_info[0]["username"]."</a> réussie</b></font>";
	$action = "action=administration&subaction=member";
	break;
	...
	$message .= "<font color='red'><b>Modification de votre profil a échouée</b></font>";
	$action = "action=profile";
	break;

	//
	case "member_modifyuser_failed_passwordcheck" :
	$message .= "<font color='red'><b>Modification de votre profil a échouée</b></font><br />";
	...
	$message .= "<font color='red'><b>Modification de votre profil a échouée</a></b></font><br />";
	...
	$message .= "<font color='lime'><b>Suppresion du membre <a>".$pub_info."</a> réussie</b></font>";
	$action = "action=administration&subaction=member";
	break;

	//
	case "deleteuser_failed" :
	$message .= "<font color='red'><b>Suppresion du membre échouée</b></font>";
	$action = "action=administration&subaction=member";
	break;
	...
	$message .= "<font color='red'><b>La configuration des paramètre serveur à echouée</b></font>";
	$action = "action=administration&subaction=parameter";
	break;

	//
	case "setting_serverconfig_success" :
	$message .= "<font color='lime'><b>Configuration des paramètre serveur achevée avec succès</b></font>";
	$action = "action=administration&subaction=parameter";
	break;
	...
	$message .= "Le nom est incorrecte</a>";
	$action = "action=administration&subaction=group";
	break;
	...
	$message .= "<font color='red'><b>Un probleme est survenu durant l'acquisition de votre empire</b></font>";
	$action = "action=home&subaction=empire";
	break;

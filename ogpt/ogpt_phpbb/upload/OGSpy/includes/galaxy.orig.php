...
function galaxy_ImportSpy(){
	...
	while ($spyreportdata = current($datas)) {
		...
		if (galaxy_add_spy($galaxy, $system, $row, $planet, $timestamp, $report, 0, 0)) {
			$spy_added++;
		}
...
//Envoie des rapports d'espionnage vers OGS à partir d'une date

...
// création des texte si missil à portée
		...
		if ($ok_missil){
		$missil_ok="<font color='#FFFF66'> à porté du (des) Silo de missiles suivant(s) : ".$ok_missil."</font> <font color='#DBBADC'>Total : ".$total_missil." MIP Dispo</font>";
		}else{$ok_missil="";$missil_ok="<font color='#FFFF66'> à porté d'aucun silo de missiles connu</font>";}

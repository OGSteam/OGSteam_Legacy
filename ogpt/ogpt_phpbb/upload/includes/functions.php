...
*
* @package phpBB3
* @version $Id: functions.php,v 1.618 2007/08/21 15:07:35 acydburn Exp $
...
include_once($phpbb_root_path . 'includes/functions_portal.'.$phpEx);
...
function page_header($page_title = '', $display_online_list = true)
{
	...
	$template->assign_vars(array(
		...
		'U_PORTAL_INDEX'		=> append_sid("{$phpbb_root_path}portal_index.$phpEx"),		

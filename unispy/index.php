<?php
/**
* Index.php Fichier entrée d'UNISPY.
* @package UniSpy
* @subpackage main
...
if (strstr($_SERVER['HTTP_USER_AGENT'], "OGSClient") === false) {
    ...
    // suppression id actions non codées
		...
		// appel fonction de modification groupés de propriétés module
	...
	// vidage contenu éventuel buffer
  while (@ob_end_clean());

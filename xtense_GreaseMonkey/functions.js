function displayOption(id){
	if(id=="Xtense_serveurs"){
		...
		document.getElementById("Xtense_table_serveurs").style.value=document.getElementById("Xtense_table_serveurs").style.value.replace("orange","white");
		...
		document.getElementById("Xtense_table_serveurs").style.value=document.getElementById("Xtense_table_serveurs").style.value.replace("white","orange");
		document.getElementById("Xtense_options").style.display="none";
		document.getElementById("Xtense_about").style.display="none";

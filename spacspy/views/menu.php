...
if ($user_auth["server_set_ranking"] == 1 || $user_data["user_admin"] == 1 || $user_data["user_coadmin"] == 1) {
	$items[] = array("none", "");
	$items[] = array("none", "----Classements----");
	$items[] = array("general", "-> Général");
	$items[] = array("fleet", "-> Vaisseaux");
	$items[] = array("defenses", "-> Défenses");
	$items[] = array("mines", "-> Mines");
	$items[] = array("research", "-> Recherches");	
}

...
foreach ($user_info as $v) {
	...
	$auth .= "<tr><th>Connexion au serveur</th><th>".$YesNo[$user_auth["spacs_connection"]]."</th></tr>";
	$auth .= "<tr><th>Importation de systèmes solaires</th><th>".$YesNo[$user_auth["spacs_set_system"]]."</th></tr>";
	$auth .= "<tr><th>Exportation de systèmes solaires</th><th>".$YesNo[$user_auth["spacs_get_system"]]."</th></tr>";
	$auth .= "<tr><th>Importation de rapports d\'espionnage</th><th>".$YesNo[$user_auth["spacs_set_spy"]]."</th></tr>";
	$auth .= "<tr><th>Exportation de rapports d\'espionnage</th><th>".$YesNo[$user_auth["spacs_get_spy"]]."</th></tr>";
	$auth .= "<tr><th>Importation de classements</th><th>".$YesNo[$user_auth["spacs_set_ranking"]]."</th></tr>";
	$auth .= "<tr><th>Exportation de classements</th><th>".$YesNo[$user_auth["spacs_get_ranking"]]."</th></tr>";
	$auth .= "</table>";

...
$link_fleet = "<a href='index.php?action=ranking&subaction=player&order_by=fleet'>Pts Vaisseaux</a>";
...
$link_research = "<a href='index.php?action=ranking&subaction=player&order_by=research'>Pts Recherches</a>";

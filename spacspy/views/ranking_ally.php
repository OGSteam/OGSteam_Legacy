...
$link_fleet = "<a href=\"index.php?action=ranking&subaction=ally&order_by=fleet\" onmouseover=\"this.T_WIDTH=120;return escape('".str_replace("type", "fleet", $tooltip)."')\">Pts Vaisseaux</a>";
$link_defenses = "<a href=\"index.php?action=ranking&subaction=ally&order_by=defenses\" onmouseover=\"this.T_WIDTH=120;return escape('".str_replace("type", "defenses", $tooltip)."')\">Pts Défenses</a>";
$link_mines = "<a href=\"index.php?action=ranking&subaction=ally&order_by=mines\" onmouseover=\"this.T_WIDTH=120;return escape('".str_replace("type", "mines", $tooltip)."')\">Pts Mines</a>";
$link_research = "<a href=\"index.php?action=ranking&subaction=ally&order_by=research\" onmouseover=\"this.T_WIDTH=120;return escape('".str_replace("type", "research", $tooltip)."')\">Pts Recherches</a>";
...
switch ($order_by) {
	...
	case "fleet": $link_fleet = str_replace("Pts Vaisseaux", "<img src='images/asc.png'>&nbsp;Pts Vaisseaux&nbsp;<img src='images/asc.png'>", $link_fleet);break;
	...
	case "research": $link_research = str_replace("Pts Recherches", "<img src='images/asc.png'>&nbsp;Pts Recherches&nbsp;<img src='images/asc.png'>", $link_research);break;
}

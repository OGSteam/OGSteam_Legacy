...
<tr>
	<td class="c" colspan="10">Système solaire </td>
</tr>
<tr>
...
foreach ($population as $v) {
	...
	if ($ally == "") $ally = "&nbsp;";
		...
		while ($ranking = current($individual_ranking)) {
			...
			$tooltip .= "<tr><td class=\"c\">Vaisseaux</td><th>".$fleet_rank."</th><th>".$fleet_points."</th></tr>";
			...
			$tooltip .= "<tr><td class=\"c\">Recherches</td><th>".$research_rank."</th><th>".$research_points."</th></tr>";
...
echo "<tr align='center'><td class='c' colspan='10'><a style='cursor:pointer' onmouseover=\"this.T_WIDTH=210;this.T_TEMP=0;return escape('".$legend."')\">Légende</a></td></tr>";
echo "</table>";
